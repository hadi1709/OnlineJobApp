...
namespace OnlineJobApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            {
                CountryList = CommonHelper.GetCountryList(),
                ReligionList = CommonHelper.GetReligionList()
            };
                ...
                if (result.Succeeded)
                {
                    ...
                    using (db_1526890_onlinejobEntities db = new db_1526890_onlinejobEntities())
                    {
                        User obj = new User
                        {
                            ...
                            CountryId = model.UserModel.CountryId,
                            ReligionId = model.UserModel.ReligionId
                        };
